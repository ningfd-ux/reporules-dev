  ...
  return (
    <footer className="border-t border-[#2a2d35] bg-[#0c0e12] pb-16 pt-10">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-6 sm:grid-cols-2 md:grid-cols-3">
        {/* Workflows */}
        <div>
          <p className="mb-4 text-xs font-medium uppercase tracking-wider text-zinc-500">Workflows</p>
          <nav className="flex flex-col gap-2.5">
            <Link href="/workflows/claude-code-saas" className="text-sm text-zinc-400 transition-colors hover:text-blue-300">Claude Code SaaS</Link>
        ...
        <div>
          ...
          <nav className="flex flex-col gap-2.5">
            ...
            <span className="text-sm text-zinc-400">testing-guidelines.md</span>
          </nav>
        </div>
      ...
      <div className="mx-auto mt-10 max-w-7xl border-t border-[#2a2d35] px-6 pt-6">
        <p className="text-xs text-zinc-500">AI workflow standards for scalable engineering teams.</p>
      </div>
    </footer>
  );
}
